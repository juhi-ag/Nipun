 <div class="form-group">	
                        	<form method="post" action="j_spring_security_check" id="adduser_form" class="form-horizontal">
	                            ...
	                            <div class="col-lg-12 ">
                        		<div class="alert alert-info">
                            		 <strong> Assumptions for Water Balance</strong> 
                        		</div>
                        		</div>
	                            
	                             <div class="col-lg-10 ">
								<div class="col-lg-5 ">
	                            <label>TDS In Raw Water</label></div> 
	                            <div class="col-lg-1 "></div>
	                            <div class="col-lg-5 ">
	                            <input type="text" class="form-control" id="j_tDSInRawWater" name="j_tDSInRawWater" placeholder="TDS In Raw Water"  />
	                            <span id="errDiv"></span></div><div class="col-lg-1 ">PPM</div>
	                            </div>
	                            
	                            <div class="col-lg-10 ">
								<div class="col-lg-5 ">
	                            <label>TDS In Raw Water Remarks</label></div> 
	                            <div class="col-lg-1 "></div>
	                            <div class="col-lg-5 ">
	                            <input type="text" class="form-control" id="j_tDSInRawWaterRemarks" name="j_tDSInRawWaterRemarks" placeholder="TDS In Raw Water Remarks"  />
	                            <span id="errDiv"></span></div><div class="col-lg-1 "></div>
	                            </div>
	                             <div class="col-lg-10 ">
								<div class="col-lg-5 ">
	                            <label>Chlorides</label></div> 
	                            <div class="col-lg-1 "></div>
	                            <div class="col-lg-5 ">
	                            <input type="text" class="form-control" id="j_chlorides" name="j_chlorides" placeholder="Chlorides"  />
	                            <span id="errDiv"></span></div><div class="col-lg-1 ">PPM</div>
	                            </div>
	                             <div class="col-lg-10 ">
								<div class="col-lg-5 ">
	                            <label>Chlorides Remarks</label></div> 
	                            <div class="col-lg-1 "></div>
	                            <div class="col-lg-5 ">
	                            <input type="text" class="form-control" id="j_chloridesRemarks" name="j_chloridesRemarks" placeholder="Chlorides Remarks"  />
	                            <span id="errDiv"></span></div><div class="col-lg-1 "></div>
	                            </div>
	                             <div class="col-lg-10 ">
								<div class="col-lg-5 ">
	                            <label>Hardness</label></div> 
	                            <div class="col-lg-1 "></div>
	                            <div class="col-lg-5 ">
	                            <input type="text" class="form-control" id="j_hardness" name="j_hardness" placeholder="Hardness"  />
	                            <span id="errDiv"></span></div><div class="col-lg-1 ">PPM</div>
	                            </div>
	                             <div class="col-lg-10 ">
								<div class="col-lg-5 ">
	                            <label>Hardness Remarks</label></div> 
	                            <div class="col-lg-1 "></div>
	                            <div class="col-lg-5 ">
	                            <input type="text" class="form-control" id="j_hardnessRemarks" name="j_hardnessRemarks" placeholder="Hardness Remarks"  />
	                            <span id="errDiv"></span></div><div class="col-lg-1 "></div>
	                            </div>
