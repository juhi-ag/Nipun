...
<body>
                ...
                <div class="row">
					 ...
					 <div class="project-col-lg-4 col-md-4">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#ProjectInfoTab" data-toggle="tab">Project Info</a>
                            </li>
                            <li class=""><a href="#WaterRequirementCalculations" data-toggle="tab">Requirement</a>
                            </li>
                            <li class=""><a href="#collingWatterRequirement" data-toggle="tab">Colling Water</a>
                            </li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active in" id="ProjectInfoTab">
                               <jsp:include page="ProjectInfoTab.jsp" />
                                
                            </div>
                            <div class="tab-pane fade" id="WaterRequirementCalculations">
								<jsp:include page="WaterRequirementCalculations.jsp" />
                            </div>
                            <div class="tab-pane fade" id="collingWatterRequirement">
                                <!-- Text 3 -->
								<jsp:include page="collingWatterRequirement.jsp" />
                            </div>
  ...
  <jsp:include page="footer.jsp" />
    ...
    <script src="../resource/js/calculateServiceWater.js"></script>
        <!-- CUSTOM SCRIPTS For Calculating Service Water Used-->
    <script src="../resource/js/calculateCollingWaterRequirement.js"></script>
</body>
</html>
